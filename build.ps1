...
#!/usr/bin/env pwsh
# .SYNOPSIS
#   cryptobase buildScript v0.1.2
# .DESCRIPTION
#   A custom build script for the module cryptobase
# .LINK
#   https://github.com/chadnpc/cryptobase/blob/main/build.ps1
# .EXAMPLE
#   ./build.ps1 -Task Test
...
# .NOTES
#   Author   : alain
#   Copyright: Copyright © 2026 alain. All rights reserved.
#   License  : MIT
